...
class knowledgePenggunaPage extends StatefulWidget {
  const knowledgePenggunaPage({Key key}) : super(key: key);

  @override
  _knowledgePenggunaPageState createState() => _knowledgePenggunaPageState();
}

class _knowledgePenggunaPageState extends State<knowledgePenggunaPage> {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                 ...
                 return TextButton(
                   onPressed: (){
                     setState(() {
                       followUpDetailPage.ticketNumber = knowledgeTiket.logNumber.toString();
                       followUpDetailPage.ticketStatusId = knowledgeTiket.status.toString();
                       followUpDetailPage.ticketDetail = knowledgeTiket.logDesc.toString();
                       followUpDetailPage.logReportId = knowledgeTiket.logReportId;
                     });
