...
class bugsListChatPage extends StatefulWidget {
  const bugsListChatPage({Key key}) : super(key: key);

  @override
  _bugsListChatPageState createState() => _bugsListChatPageState();
}

class _bugsListChatPageState extends State<bugsListChatPage> {
  var apiURLListBugs = "http://192.168.43.149:8080/api/dashboard/status-report/my-tiket/bugs";
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailPage.ticketNumber = bugsTiket.logNumber.toString();
                      followUpDetailPage.ticketStatusId = bugsTiket.status.toString();
                      followUpDetailPage.ticketDetail = bugsTiket.logDesc.toString();
                      followUpDetailPage.logReportId = bugsTiket.logReportId;
                    });
