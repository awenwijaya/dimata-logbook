...
class supportListChatPage extends StatefulWidget {
  const supportListChatPage({Key key}) : super(key: key);

  @override
  _supportListChatPageState createState() => _supportListChatPageState();
}

class _supportListChatPageState extends State<supportListChatPage> {
  var apiURLListSupport = "http://192.168.43.149:8080/api/dashboard/status-report/my-tiket/support";
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailPage.ticketNumber = supportTiket.logNumber.toString();
                      followUpDetailPage.ticketStatusId = supportTiket.status.toString();
                      followUpDetailPage.ticketDetail = supportTiket.logDesc.toString();
                      followUpDetailPage.logReportId = supportTiket.logReportId;
                    });
