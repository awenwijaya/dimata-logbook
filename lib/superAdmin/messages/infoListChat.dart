...
class infoSuperAdminPage extends StatefulWidget {
  const infoSuperAdminPage({Key key}) : super(key: key);

  @override
  _infoSuperAdminPageState createState() => _infoSuperAdminPageState();
}

class _infoSuperAdminPageState extends State<infoSuperAdminPage> {
  var apiURLListInfo = "http://192.168.43.149:8080/api/super-admin/status-report/info";
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailSuperAdminPage.ticketNumber = infoTiket.logNumber.toString();
                      followUpDetailSuperAdminPage.ticketStatusId = infoTiket.status.toString();
                      followUpDetailSuperAdminPage.ticketDetail = infoTiket.logDesc.toString();
                      followUpDetailSuperAdminPage.logReportId = infoTiket.logReportId;
                    });
