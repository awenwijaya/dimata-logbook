...
class supportListSuperAdminPage extends StatefulWidget {
  const supportListSuperAdminPage({Key key}) : super(key: key);

  @override
  _supportListSuperAdminPageState createState() => _supportListSuperAdminPageState();
}

class _supportListSuperAdminPageState extends State<supportListSuperAdminPage> {
  var apiURLListSupport = "http://192.168.43.149:8080/api/super-admin/status-report/support";
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailSuperAdminPage.ticketNumber = supportTiket.logNumber.toString();
                      followUpDetailSuperAdminPage.ticketStatusId = supportTiket.status.toString();
                      followUpDetailSuperAdminPage.ticketDetail = supportTiket.logDesc.toString();
                      followUpDetailSuperAdminPage.logReportId = supportTiket.logReportId;
                    });
