...
class ideInisiatifSaranSuperAdminPage extends StatefulWidget {
  const ideInisiatifSaranSuperAdminPage({Key key}) : super(key: key);

  @override
  _ideInisiatifSaranSuperAdminPageState createState() => _ideInisiatifSaranSuperAdminPageState();
}

class _ideInisiatifSaranSuperAdminPageState extends State<ideInisiatifSaranSuperAdminPage> {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailSuperAdminPage.ticketNumber = ideTiket.logNumber.toString();
                      followUpDetailSuperAdminPage.ticketStatusId = ideTiket.status.toString();
                      followUpDetailSuperAdminPage.ticketDetail = ideTiket.logDesc.toString();
                      followUpDetailSuperAdminPage.logReportId = ideTiket.logReportId;
                    });
