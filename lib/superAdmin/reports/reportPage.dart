...
class reportPageSuperAdmin extends StatefulWidget {
  const reportPageSuperAdmin({Key key}) : super(key: key);

  @override
  _reportPageSuperAdminState createState() => _reportPageSuperAdminState();
}

class _reportPageSuperAdminState extends State<reportPageSuperAdmin> {
  int reportDoneBugs = 0;
  int reportDoneProblems = 0;
  int reportDoneSupport = 0;
  int reportDoneRequest = 0;
  var apiURLReportDoneBugs = "http://192.168.43.149:8080/api/log-report/count/done/bugs";
  var apiURLReportDoneProblems = "http://192.168.43.149:8080/api/log-report/count/done/problems";
  var apiURLReportDoneSupport = "http://192.168.43.149:8080/api/log-report/count/done/support";
  var apiURLReportDoneRequest = "http://192.168.43.149:8080/api/log-report/count/done/requests";
