...
class reportCategoriesSuperAdmin extends StatefulWidget {
  const reportCategoriesSuperAdmin({Key key}) : super(key: key);

  @override
  _reportCategoriesSuperAdminState createState() => _reportCategoriesSuperAdminState();
}

class _reportCategoriesSuperAdminState extends State<reportCategoriesSuperAdmin> {
  @override
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return TextButton(
                            onPressed: (){
                              setState(() {
                                addTicketSuperAdminPage.reportIdSelected = kategoriTiketData.rptTypeId;
                                addTicketSuperAdminPage.reportNameSelected = kategoriTiketData.typeName;
                                addTicketSuperAdminPage.reportTypeSelected = kategoriTiketData.statusRpt;
                              });
