...
import 'package:dimata_logbook/superAdmin/chatsSuperAdmin/checkedByUser/checkByUser.dart';
...
class addFollowUpSuperAdminPage extends StatefulWidget {
  static var chkByUserId;
  static var chkByUserName = "No checked by user selected";
  const addFollowUpSuperAdminPage({Key key}) : super(key: key);

  @override
  _addFollowUpSuperAdminPageState createState() => _addFollowUpSuperAdminPageState();
}

class _addFollowUpSuperAdminPageState extends State<addFollowUpSuperAdminPage> {
          ...
          child: Column(
            children: <Widget>[
              ...
              Positioned(
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                        child: Text(
                          addFollowUpSuperAdminPage.chkByUserName,
                          style: TextStyle(
                              fontSize: 15,
                              fontWeight: FontWeight.bold
                          ),
                    ...
                    Container(
                        child: RaisedButton(
                          onPressed: (){
                            Navigator.of(context).push(PageTransition(child: checkByUser(), type: PageTransitionType.bottomToTop));
                          },
                          child: Text("Select Checked By User"),
                        ),
                        margin: EdgeInsets.only(top: 10)
                    )
                  ],
              ...
              Container(
                child: RaisedButton(
                  onPressed: () async {
                    if(controllerFollowUpNote.text == '' || addFollowUpSuperAdminPage.chkByUserId == null) {
                      ...
                      var body = jsonEncode({
                        ...
                        "chkByUserId" : addFollowUpSuperAdminPage.chkByUserId
                      });
