...
class infoAdminPage extends StatefulWidget {
  ...
  @override
  _infoAdminPageState createState() => _infoAdminPageState();
}
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailAdminPage.ticketNumber = infoTiket.logNumber.toString();
                      followUpDetailAdminPage.ticketStatusId = infoTiket.status.toString();
                      followUpDetailAdminPage.ticketDetail = infoTiket.logDesc.toString();
                      followUpDetailAdminPage.logReportId = infoTiket.logReportId;
                    });
