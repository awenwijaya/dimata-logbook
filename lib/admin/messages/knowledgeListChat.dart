...
class knowledgeAdminPage extends StatefulWidget {
  const knowledgeAdminPage({Key key}) : super(key: key);

  @override
  _knowledgeAdminPageState createState() => _knowledgeAdminPageState();
}
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailAdminPage.ticketNumber = knowledgeTiket.logNumber.toString();
                      followUpDetailAdminPage.ticketStatusId = knowledgeTiket.status.toString();
                      followUpDetailAdminPage.ticketDetail = knowledgeTiket.logDesc.toString();
                      followUpDetailAdminPage.logReportId = knowledgeTiket.logReportId;
                    });
