            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TextButton(
                  onPressed: (){
                    setState(() {
                      followUpDetailAdminPage.ticketNumber = ideTiket.logNumber.toString();
                      followUpDetailAdminPage.ticketStatusId = ideTiket.status.toString();
                      followUpDetailAdminPage.ticketDetail = ideTiket.logDesc.toString();
                      followUpDetailAdminPage.logReportId = ideTiket.logReportId;
                    });
