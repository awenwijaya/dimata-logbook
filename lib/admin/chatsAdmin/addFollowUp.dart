...
class addFollowUpAdminPage extends StatefulWidget {
  ...
  @override
  _addFollowUpAdminPageState createState() => _addFollowUpAdminPageState();
}

class _addFollowUpAdminPageState extends State<addFollowUpAdminPage> {
                    ...
                    if(controllerFollowUpNote.text == '') {
                      ...
                      http.post(Uri.parse(apiURLAddFollowUp),
                        ...
                        if(responseValue == 200) {
                          setState(() {
                            Loading = false;
                            Navigator.of(context).push(PageTransition(child: bottomNavigationAdmin(), type: PageTransitionType.topToBottom));
                          });
                        }
                      });
                    }
