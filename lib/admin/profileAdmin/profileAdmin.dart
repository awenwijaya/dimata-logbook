...
import 'package:dimata_logbook/admin/profileAdmin/editProfileAdmin.dart';
...
class profileAdmin extends StatefulWidget {
  static var adminEmail = "Your Email";
  ...
  getAdminInfo() async {
    http.post(Uri.parse(apiURL),
      ...
      if(responseValue == 200) {
        ...
        setState(() {
          profileAdmin.adminEmail = parsedJson['email'];
          profileAdmin.phoneNumber = parsedJson['loginId'];
          profileAdmin.fullName = parsedJson['fullName'];
        });
      }
    });
  }
      ...
      home: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Container(
              alignment: Alignment.topLeft,
              child: Text(profileAdmin.fullName, style: TextStyle(fontSize: 17)),
            ...
            Container(
              alignment: Alignment.topLeft,
              child: Text(profileAdmin.adminEmail, style: TextStyle(fontSize: 17)),
            ...
            Container(
              alignment: Alignment.topLeft,
              child: Text(profileAdmin.phoneNumber, style: TextStyle(fontSize: 17)),
              margin: EdgeInsets.only(top: 15, left: 30)
            ),
            Container(
              alignment: Alignment.center,
              child: RaisedButton(
                onPressed: (){
                  Navigator.push(context, PageTransition(child: editProfileAdmin(), type: PageTransitionType.bottomToTop));
                },
